...
module.exports = {
  ...
  rawApiUrl: process.env.RAW_API_URL || 'https://raw.githubusercontent.com', // Used for files over 20MB (jsDelivr can't serve them)
  ...
  imageMimetypes: process.env.IMAGE_MIMETYPES || "['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/webp', 'image/svg+xml', 'image/avif', 'image/heif', 'image/heic', 'image/x-icon', 'image/ico', 'image/svg', 'image/microsoft', 'image/tiff']",
